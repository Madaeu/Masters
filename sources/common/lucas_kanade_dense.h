...
namespace msc
{
                          ...
                          const Scalar huberDelta)
    {
        ...
        //printf(correspondence.valid ? "true" : "false");
        if(correspondence.valid)
        {
            // Determine the Jacobian
            const Eigen::Matrix<Scalar,2,6> correspondenceJac = msc::findCorrespondenceJacPose<Scalar>(correspondence, depth0(x,y), camera, pose);
