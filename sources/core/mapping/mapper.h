...
public:
    ...
    void initOneFrame(double timestamp, const cv::Mat& image, const cv::Mat& color, const Features& features);
...
template<typename Scalar, int CS>
void
Mapper<Scalar, CS>::initOneFrame(double timestamp, const cv::Mat& image, const cv::Mat& colorImage, const Features &features) {
    reset();
...
template<typename Scalar, int CS>
void
Mapper<Scalar, CS>::initTwoFrames(double timestamp0, double timestamp1, const cv::Mat &image0, const cv::Mat &image1,
                                  const cv::Mat &image0Color, const cv::Mat &image1Color, const Features &features0,
...
template<typename Scalar, int CS>
typename Mapper<Scalar, CS>::KeyframePtr Mapper<Scalar, CS>::buildKeyframe(double timestamp, const cv::Mat &image, const cv::Mat &colorImage,
                                                      const Mapper::SE3T &initialPose, const Features features) {
